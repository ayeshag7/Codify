...
const BlogPageHeader = () => {
    const navElement = "block py-2 pl-3 pr-4 text-black rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:underline md:border-0";

    const [hidden, setHidden] = useState(true);

  return (
    <nav className="bg-white mt-0 mb-2 mx-0 md:rounded-full md:mx-0 md:my-0">

        <div className="max-w-screen-xl flex flex-wrap items-center justify-between border border-gray-400 shadow mx:0 md:mx-auto py-6 px-6">
            ...
            <div className={`${hidden ? "hidden" : ""} w-full md:block md:w-auto`} id="navbar-default">
                <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-4 md:mt-0">
                    ...
                    <li>
                        <Link href="/" className={navElement}>Blogs</Link>
                    </li>
                </ul>
            ...
            <div className="hidden md:flex md:justify-between md:items-center gap-x-8">
