    ...
    <div className="bg-backgroundSkin p-0 md:p-4 border border-t-black" style={{
        ...
        <div className="flex flex-wrap justify-between md:justify-around px-4 pt-16 pb-20">
            ...
            <div className="relative flex flex-col gap-y-4 md:gap-y-6 ml-6 my-8 md:m-0">
                ...
                <div className="flex justify-start items-center gap-x-2">
                    <div className="flex justify-center items-center h-12 w-12 rounded-full bg-white border border-black">
                        <a href="https://github.com/ayeshag7" rel="noreferrer" target="_blank" className="text-blue-500">
                ...
                <div className="flex justify-start items-center gap-x-2">
                    <div className="flex justify-center items-center h-12 w-12 rounded-full bg-white border border-black">
                        <a href="https://github.com/ayeshag7" rel="noreferrer" target="_blank" className="text-pink-600">
